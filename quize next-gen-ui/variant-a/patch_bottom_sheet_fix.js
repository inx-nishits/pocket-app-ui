...
const startStr = '<!-- Screen: Activity History -->';
const startIndex = html.indexOf(startStr);

if (startIndex !== -1) {
    // Find the end of the view-activity div.
    // It ends right before </body>
...
\n`;
        ...
        html = html.substring(0, startIndex) + bottomSheetHtml + html.substring(endIndex);
        
        // Ensure the click handler is correct
        html = html.replace(/QuizEngine\.navigate\('view-activity'\)/g, 'showActivitySheet()');
        
        fs.writeFileSync('quiz.html', html, 'utf8');
        console.log("Successfully replaced full screen with Bottom Sheet.");
    }
}
